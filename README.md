...
5. ต่อรีเลย์ 4 ช่องเข้ากับขา D5, D6, D7 และ D8 ตามลำดับ (Active LOW)
6. ระบบจะเริ่มทำงานตามตารางเวลาที่ตั้งไว้สำหรับรีเลย์ช่อง 1 / ปั๊มน้ำ (ค่าเริ่มต้นคือ 06:00-06:10 และ 17:00-17:10)
7. หน้าเว็บ Admin V7 ใช้ MQTT Cloud เดียวกับบอร์ดผ่าน WebSocket จึงควบคุมและดูสถานะรีเลย์ทั้ง 4 ช่องร่วมกันได้
8. สามารถควบคุมผ่าน MQTT Dashboard ได้ตาม Topic ที่กำหนด
